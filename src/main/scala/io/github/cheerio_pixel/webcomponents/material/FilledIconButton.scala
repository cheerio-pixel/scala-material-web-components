...
/** md-filled-icon-button component
  */
object FilledIconButton extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/iconbutton/filled-icon-button.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-filled-icon-button")
}
