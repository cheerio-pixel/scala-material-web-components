...
/** md-filled-text-field component
   * TODO(b/228525797): Add docs
  */
object FilledTextField extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/textfield/filled-text-field.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-filled-text-field")
}
