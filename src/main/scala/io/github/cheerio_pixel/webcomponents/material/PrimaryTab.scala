...
/** md-primary-tab component
  
  */
object PrimaryTab extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/tabs/primary-tab.js", JSImport.Default)
  object RawImport extends js.Object

  used(RawImport)

  type Ref = dom.html.Element & RawElement
  lazy val inlineIcon: HtmlAttr[Boolean] = htmlAttr("inline-icon", BooleanAsAttrPresenceCodec)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-primary-tab")
}
