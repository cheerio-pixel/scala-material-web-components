...
/** md-navigation-drawer component
  
  */
object NavigationDrawer extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/labs/navigationdrawer/navigation-drawer.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-navigation-drawer")
}
