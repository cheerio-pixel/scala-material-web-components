...
/** md-filled-button component
  ...
  */
object FilledButton extends AbstractButton {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/button/filled-button.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-filled-button")
}
