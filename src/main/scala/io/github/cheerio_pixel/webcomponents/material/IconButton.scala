...
/** Icon buttons help people take supplementary actions with a single tap.
  *
  * @see
  *   <a href="https://material-web.dev/components/icon-button/#icon-button">the
...
object IconButton extends WebComponent {
  ...
  @js.native
  @JSImport("@material/web/iconbutton/icon-button.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-icon-button")
}
