...
/** md-outlined-select component
  
  */
object OutlinedSelect extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/select/outlined-select.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-outlined-select")
}
