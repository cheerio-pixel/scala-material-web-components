...
/** md-outlined-button component
  
  */
object OutlinedButton extends AbstractButton {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/button/outlined-button.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-outlined-button")
}
