...
/** md-outlined-card component
  
  */
object OutlinedCard extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/labs/card/outlined-card.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-outlined-card")
}
