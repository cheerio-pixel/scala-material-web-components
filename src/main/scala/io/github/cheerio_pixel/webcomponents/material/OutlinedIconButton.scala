...
/** md-outlined-icon-button component
  
  */
object OutlinedIconButton extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/iconbutton/outlined-icon-button.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-outlined-icon-button")
}
