...
/** md-filled-field component
   * TODO(b/228525797): add docs
  */
object FilledField extends WebComponent {
  @js.native
  trait RawElement extends js.Object

  @js.native
  @JSImport("@material/web/field/filled-field.js", JSImport.Default)
  ...
  protected val tag: CustomHtmlTag[Ref] = CustomHtmlTag("md-filled-field")
}
